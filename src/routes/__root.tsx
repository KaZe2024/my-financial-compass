...
import { registerPWA } from "@/lib/offline/register-sw";
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Cette route n'existe pas dans votre OPTIS.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "OPTIS — Optimized Personal Terminal Intelligent System" },
      ...
      { property: "og:title", content: "OPTIS — Optimized Personal Terminal Intelligent System" },
      { name: "twitter:title", content: "OPTIS — Optimized Personal Terminal Intelligent System" },
...
function RootShell({ children }: { children: ReactNode }) {
  return (
    <html lang="fr" className="dark theme-bloomberg">
